...
xgb_param_dist = {
    ...
    'subsample': uniform(0.6, 0.4),  # This ensures the range is [0.6, 1.0]
    'colsample_bytree': uniform(0.6, 0.4),  # This ensures the range is [0.6, 1.0]
...
print("Modelo ensemble y scaler guardados exitosamente.")

# Guardar el LabelEncoder para cada columna categórica
label_encoders = {}
for col in categorical_columns:
    le = LabelEncoder()
    le.fit(df[col])
...
print("Label encoders guardados exitosamente.")

# Guardar la lista de características
joblib.dump(features, 'features.joblib')

print("Lista de características guardada exitosamente.")
